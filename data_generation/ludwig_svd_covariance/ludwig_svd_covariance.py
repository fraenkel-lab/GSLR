...
#SBATCH --job-name=DATA_GEN1
#SBATCH --output=/home/lenail/proteomics/synthetic_proteomics/data_generation/ludwig_svd_covariance/multiprocess_%j.out
#SBATCH -N 1
#SBATCH -n 16
...
def generate_dataset(pathway_id, pathway_genes, proteomics, POSITIVE_SAMPLES=100, NEGATIVE_SAMPLES=100):
	...
	filename = '/home/lenail/proteomics/synthetic_proteomics/generated_data/ludwig_svd_normals/'+pathway_id+'_inbiomap_exp.csv'
