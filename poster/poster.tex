...
\begin{column}{.3\linewidth}
	...
	\begin{block}{Synthetic Data}
		...
		we create synthetic data by sampling from the multivariate gaussian
		defined by the real data, then translating "positive" examples by a "perturbation" vector.
