...
if __name__ == "__main__":
	...
	files = [(pathway_id, project_root+'generated_data/ludwig_svd_normals_gaussian_mixture/'+pathway_id+'_inbiomap_exp.csv') for pathway_id in pathways_df.index.get_level_values(2)]
